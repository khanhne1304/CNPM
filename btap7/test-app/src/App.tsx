...
// ⬇️ ĐỔI TÊN gói thành gói bạn đã publish
import { CartProvider, CartPanel, CartModalButton, AddToCartButton, Card } from "@khanhphan1415/cart-ui-library";
        ...
        <Card title="Sản phẩm">
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill,minmax(220px,1fr))", gap: 12 }}>
            {[
              ...
              { id: "p2", name: "Giày chạy",   price: 899000, image: "https://picsum.photos/seed/b/200" },
